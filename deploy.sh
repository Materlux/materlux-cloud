...
gcloud run deploy "$SERVICE" \
  ...
  --set-env-vars "^@^WA_PROVIDER=zapi@WA_VERIFY_TOKEN=materlux-verify@CLINIC_TZ=America/Sao_Paulo@COOKIE_SECURE=true@GEMINI_MODEL=gemini-2.5-flash@BOOKABLE_PROFESSIONAL_IDS=1,4,12"
